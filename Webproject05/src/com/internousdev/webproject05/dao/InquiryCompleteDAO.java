package com.internousdev.webproject05.dao;
...
import com.internousdev.webproject05.dto.InquiryDTO;
import com.internousdev.webproject05.util.DBConnector;
	...
	public List<InquiryDTO> select(){
		...
		try{
			...
			while(rs.next()){
				...
				dto.setBody(rs.getNString("body"));
